...
public class Cano {
	...
	public void drawItself(Tela t){
		t.imagem("flappy.png", 660, 0, 52, 242, 0, x, y + HOLESIZE); //cano virado pra cima
		t.imagem("flappy.png", 660, 42, 52, 200, 0, x, y + HOLESIZE + 242); //resto do cano virado pra cima
